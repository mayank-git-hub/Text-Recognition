...
from ..helper.utils import CrossEntropyLoss, get_connected_components, scores
...
class DenseNet(model):
    ...
    def __init__(self, config=None, profiler=None, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0, num_classes=1000):

        super().__init__()#DenseNet, self
        self.config = config
